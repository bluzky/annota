...
@MainActor
public enum ObjectViewRegistry {
    ...
    public static func register<T: CanvasObject>(
        _ type: T.Type,
    ...
    public static func registerExport<T: CanvasObject>(
        _ type: T.Type,
    ...
    public static func view(for object: AnyCanvasObject, isSelected: Bool, viewModel: CanvasViewModel) -> AnyView {
    ...
    public static func exportView(for object: AnyCanvasObject) -> AnyView {
