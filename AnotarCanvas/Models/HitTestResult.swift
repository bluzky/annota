...
public enum Corner: String, CaseIterable, Codable, Hashable {
    case topLeft
    case topRight
    case bottomLeft
    case bottomRight
...
public enum Edge: String, CaseIterable, Codable, Hashable {
    case top
    case right
    case bottom
    case left
...
public enum HitTestResult: Hashable {
