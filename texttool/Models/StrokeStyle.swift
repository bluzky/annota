...
enum StrokeStyleType: Codable, Hashable {
    case solid
    ...
    static var defaultDashed: StrokeStyleType {
        .dashed(pattern: [8, 4])
    }
...
extension StrokeStyleType {
    /// Creates a SwiftUI StrokeStyle with the given line width
    func swiftUIStrokeStyle(lineWidth: CGFloat, lineCap: CGLineCap = .round, lineJoin: CGLineJoin = .round) -> SwiftUI.StrokeStyle {
        SwiftUI.StrokeStyle(
            lineWidth: lineWidth,
            lineCap: lineCap,
            lineJoin: lineJoin,
